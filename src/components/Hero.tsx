...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero">
      <Image src="/deck-assets/image6.jpg" alt="" fill className="object-cover opacity-30" priority />
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        {/* MBSX badge */}
        <div className="inline-flex items-center gap-3 px-5 py-2.5 mb-8 border border-teal/30 rounded-full bg-white/5 backdrop-blur-md hero-badge-glow">
        ...
        <h1 className="text-5xl sm:text-6xl md:text-8xl font-bold mb-6 leading-[0.95] tracking-tight text-white">
          The $15 Trillion
          <br />
          <span className="text-gradient-hero-heading">Opportunity</span>
        </h1>
        ...
        <p className="text-white/50 text-sm md:text-base mb-12 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-14 max-w-3xl mx-auto">
          {[
            ...
            <div key={stat.label} className="stat-card group py-4 px-4 rounded-xl bg-white/[0.04] border border-white/[0.08] backdrop-blur-sm hover:bg-white/[0.08] hover:border-teal/30 transition-all duration-500">
              <div className="text-2xl md:text-3xl font-bold text-teal-light group-hover:text-white transition-colors duration-300">{stat.value}</div>
