...
const documents = [
  {
    title: "Whitepaper",
    description: "OWNR's dual-token architecture, market impact, and roadmap for expanding beyond MBS.",
    type: "PDF",
    icon: (
  ...
  },
  {
    ...
    description: "Revenue projections, trading fees, data monetization, and costs to show scalability and profitability.",
    type: "XLSX",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: "Tech Proposal",
    description: "Tokenization engine, synthetic AMM exchange, primary exchange, oracle integration, wallets, and compliance reporting.",
    type: "PDF",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: "MVP Demo",
    description: "Full lifecycle demo showing UMBS deposits creating Primary tokens, locked to mint Synthetic tokens with 24/7 swaps.",
    type: "LINK",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Regulatory pathway, licensing, compliance policies, and custodial framework.",
    type: "PDF",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: "Investor Deck",
    description: "2026 pitch deck for institutional and strategic investors.",
    type: "PPTX",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-md w-full mx-4 text-center">
          <div className="bg-white rounded-2xl border border-slate-200 p-10 shadow-sm">
            ...
            <p className="text-slate-500 text-sm mb-8">
              Enter your access code to view confidential documents.
            </p>
            <form onSubmit={handleUnlock} className="space-y-4">
              ...
              />
              {error && (
                <p className="text-red text-sm">Invalid access code. Please try again.</p>
              )}
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500">
            Access OWNR&apos;s confidential investor documents and resources.
          </p>
        </div>
              ...
              <div className="p-6">
                ...
                {doc.available ? (
                  <button className="text-sm text-teal hover:text-teal-dark font-semibold transition-colors flex items-center gap-1.5">
                    {doc.type === "LINK" ? "Open Demo" : "Download"}
